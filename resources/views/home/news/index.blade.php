...
<html>
	...
	<head>
		...
		<link href="/h/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css"> <link href="/h/AmazeUI-2.4.2/assets/css/amazeui.css" rel="stylesheet" type="text/css">

		<link href="/h/css/personal.css" rel="stylesheet" type="text/css">
		<link href="/h/css/newstyle.css" rel="stylesheet" type="text/css">
								...
								<div class="am-tab-panel am-fade am-in am-active" id="tab1">
									...
									<div class="news-day">
										<div class="goods-date" data-date="2015-12-21">
											<span><i class="month-lite">{{$v->created_at}}</i>
										</div>

										<!--消息 -->
										<div class="s-msg-item s-msg-temp i-msg-downup">
											<h6 class="s-msg-bar"><span class="s-name">{{$v->title}}</span></h6>
										...
										<form action="/home/news/{{ $v->id }}" method='post' style='display:inline-block'>
				                            {{csrf_field()}}
				                            {{method_field('DELETE')}}
				                            <input type="submit" class="i-btn-forkout am-icon-close am-icon-fw" value='×' class='btn btn-danger' >
				                        </form>
