			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">绑定手机</strong> / <small>Phone</small></div>
					</div>
					<hr/>
					<!--进度条-->
					...
					<form class="am-form am-form-horizontal">
						<div class="am-form-group">
							<label for="user-old-password" class="am-form-label">手机</label>
							<div class="am-form-content">
								<input type="tel"  id="user-old-password" placeholder="手机号">
							</div>
						</div>
			...
			<script  type="text/javascript">
				$.ajaxSetup({
				  ...
				  function  update(){
				  	  ...
				  	  let phone =  $('#user-old-password').eq(0).val();
				  	  
				  	  $.post('/home/email/storephone', {phone},function(res){
                             if(res.msg = 'error'){
                             	layer.msg(res.info)
                             }else{
                             	alert(res.info)
