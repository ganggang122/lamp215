...
@section('content')
			<div class="mws-panel grid_8">
                                        ...
                                        <td>
                     					...
                     					<td > 
                                            <button class='btn' onclick='changeTop({{$v->id}})'>置顶</button>
                     						...
                     						<a href='/admin/seckill/{{ $v->id }}/edit' class='btn btn-primary'>修改</a>
                     						
                                            <form action='/admin/seckill/{{ $v->id }}' method='post' style='display:inline-block'>
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
        		...
        		<script type="text/javascript">
        			...
        			{
        				$.get('/admin/seckill/changeStatus',{id},function(res){
